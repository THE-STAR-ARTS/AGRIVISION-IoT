...
pin = Pin(22, Pin.OUT, Pin.PULL_DOWN)  #Setup the pin for communications with the DHT11
sensor = DHT11(pin)                    #Create the sensor object
sleep(5.0)                             #IMPORTANT - must sleep a min of 1 second to allow DHT11 to start up

while True:        #Loop until Reads <= zero
    ...
    print(Temperature_F,"F  ",Temperature_C,"C  ",  Humidity, "% ")
